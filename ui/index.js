...
var UBIcontractAddress = '0x0165878A594ca255338adfa4d48449f69242Eb8F';
var fakePoHAddress = '0xDc64a140Aa3E981100a9becA4E685f962f0cF6C9';
...
function getBalance(account) {
  ...
  contract.methods[encodedFunction](account).call().then(function(balance) {
...
function getBalanceFromStream(streamId, account) {
  ...
  contract.methods[encodedFunction](streamId).call().then(function(balance) {
    $("#address").html(account);
    $("#balance").html(formatBalanceAmount(balance));
  });
}
