...
var UBIContractAddress = '0x7bc06c482DEAd17c0e297aFbC32f6e63d3846650';
var contractAddress = '0xc351628EB244ec633d5f21fBD6621e1a683B1181';
...
function distributeUBI() {
  ...
  contract.methods.distributeUBIToRecipients([address1, address2, address3], 3).send({from: account1}).then(function(tx) {
    showResult("true");
    console.log("Transaction: ", tx);
  }).catch(function(err) {
    showResult("false");
